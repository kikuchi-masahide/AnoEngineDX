...
public:
	...
	/// </summary>
	void CreateSwapChain(DX12::Master& dx12, DX12::CommandQueue cmd_queue);
	/// <summary>
	/// このswapchainをrender targetにするコマンドを、cmd_listにセットする。
	/// </summary>
	void SetRenderTarget(DX12::GraphicsCommandList cmd_list) const;
	/// <summary>
	...
	void SetRenderTarget(DX12::GraphicsCommandList cmd_list,
		DX12::DescriptorHeap dsv_heap, int dsv_index) const;
	/// <summary>
	/// このswapchainのbackbufferのstateを、beforeからafterへ変更する
	/// </summary>
	void SetBackbufferStateBarrier(DX12::GraphicsCommandList cmd_list,
		D3D12_RESOURCE_STATES before, D3D12_RESOURCE_STATES after) const;
	/// <summary>
	/// このswapchainのbackbufferを、指定色でクリアする
	/// </summary>
	void ClearBackbuffer(DX12::GraphicsCommandList cmd_list, float r, float g, float b) const;
	/// <summary>
	...
	DX12::SwapChain GetSwapchain() const;
private:
